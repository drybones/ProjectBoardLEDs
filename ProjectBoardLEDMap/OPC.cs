...
namespace ProjectBoardLEDs
{
    ...
    /*
     * Translated and simplified from the java library:
     * https://github.com/scanlime/fadecandy/blob/5efd0523acee0d7117fc7ed53cb412975d72ebe9/examples/processing/grid8x8_dot/OPC.pde
     * 
    ...
    public class OPC : IDisposable
    {
        ...
        public void sendColorCorrectionPacket()
        {
            ...
            byte[] content = System.Text.Encoding.ASCII.GetBytes(colorCorrection);
        ...
        public void setPixel(int number, byte r, byte g, byte b)
        {
            ...
            packetData[offset] = r;
            packetData[offset + 1] = g;
            packetData[offset + 2] = b;
        }
        ...
        public void writePixels()
        {
            ...
            try
            {
                output.Write(packetData, 0, packetData.Length);
            }
            catch (Exception e)
            {
                Dispose();
        ...
        private void connect()
        {
            ...
            try
            {
                ...
                Debug.WriteLine("Connected to OPC server");
            }
            catch (Exception e)
            {
                Dispose();
        ...
        public void Dispose()
        {
            ...
            if (output != null)
            {
                Debug.WriteLine("Disconnected from OPC server");
            }
            socket = null;
            output = null;
        }
